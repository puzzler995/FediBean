...
class JsonTests {
  ...
  void canReadMediaType() {
    try {
      String content =
          "{\"type\": \"Image\",\"mediaType\": \"image/jpeg\",\"url\": \"https://cdn.mastodon.example/test_actor/accounts/avatars/109/497/783/827/254/564/original/b0adb5063df194a6.jpg\"}";
      ...
      assertThat(actual.getType()).contains("Image");
