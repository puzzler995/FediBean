...
public final class APConstants {
  ...
  public static final Map<String, Class<? extends Resolvable>> CLASS_MAP =
      Map.ofEntries(
          ...
          entry("Image", APObject.class),
          entry("Object", APObject.class),
          entry(NAME_NOTE, APObject.class),
          entry("Article", APObject.class),
          entry("Audio", APObject.class),
          entry("Document", APObject.class),
          entry("Event", APObject.class),
          entry("Page", APObject.class),
          entry("Video", APObject.class),
          entry("Tombstone", APObject.class),
          entry("devices", Collection.class),
          entry("PropertyValue", APObject.class));
