...
function vq(a,b){var c,d;c=b.b.status;$j&&NC($wnd.console,'Server returned '+c+' for xhr');if(c==401){Ns(Ic(lk(a.c,zf),15));Un(Ic(lk(a.c,ye),22),'');d=Ic(lk(a.c,De),12);d.b!=(Fo(),Eo)&&po(d,Eo);}else{eq(a,(Dq(),Cq),b.a)}}
